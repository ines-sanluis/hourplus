    ...
    <>
      ...
      <main>
        <div className={style.results}>
          {/* Total */}
          <div>
            <Time time={msToString(shift)} title="Xornada" />
            <Time
              time={total}
              title="Total"
          ...
          <div>
            <Time
              ...
              disabled={
                startDate === undefined || endDate === undefined || isFreeDay
              }
            />
            <Range
